      ...
      <div className="wc-grid" style={{ marginTop: '20px' }}>
        ...
        <div className="wc-matches-section">
          ...
          <div className="wc-channels-header" style={{ display: 'flex', gap: '8px', marginBottom: '16px', flexWrap: 'wrap', alignItems: 'center', background: 'rgba(15, 23, 42, 0.3)', padding: '10px 14px', borderRadius: '8px', border: '1px solid rgba(255, 255, 255, 0.05)' }}>
            ...
            <button className="wc-watch-btn" onClick={() => onWatchLive("Low latency server")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>Low Latency Server</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("Server 1")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>Server 1</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("Server 2")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>Server 2</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("Server 3")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>Server 3</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("Server 4")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>Server 4</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("Server 5")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>Server 5</button>
            ...
            <button className="wc-watch-btn" onClick={() => onWatchLive("Unite 8 Sports 1 HD")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>Unite 8 Sports 1 HD</button>
              ...
              <div style={{ background: 'linear-gradient(145deg, #1e293b, #0f172a)', borderRadius: '12px', border: '1px solid var(--wc-gold)', padding: '20px', marginBottom: '24px', position: 'relative', overflow: 'hidden', boxShadow: '0 10px 30px -10px rgba(0,0,0,0.5)' }}>
                ...
                {(matchOfTheDay.status === 'IN_PLAY' || matchOfTheDay.status === 'PAUSED') && (
                  <div style={{ display: 'flex', gap: '10px', width: '100%' }}>
                    <button onClick={() => onWatchLive("Fast Server")} style={{ flex: 1, padding: '12px', borderRadius: '8px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '900', border: 'none', cursor: 'pointer', fontSize: '13px', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px', transition: 'all 0.2s', textTransform: 'uppercase' }}>
                      <PlayCircle size={18} /> Fast Server
                    </button>
                    <button onClick={() => onWatchLive("Bein Sports")} style={{ flex: 1, padding: '12px', borderRadius: '8px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '900', border: 'none', cursor: 'pointer', fontSize: '13px', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px', transition: 'all 0.2s', textTransform: 'uppercase' }}>
                      <PlayCircle size={18} /> Bein Sports
                    </button>
