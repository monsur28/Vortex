      ...
      <div className="wc-grid">
        ...
        <div className="wc-matches-section">
          ...
          <div className="wc-channels-header" style={{ display: 'flex', gap: '8px', marginBottom: '16px', flexWrap: 'wrap', alignItems: 'center', background: 'rgba(15, 23, 42, 0.3)', padding: '10px 14px', borderRadius: '8px', border: '1px solid rgba(255, 255, 255, 0.05)' }}>
            ...
            <button className="wc-watch-btn" onClick={() => onWatchLive("Fox Sport [English]")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>Fox Sport EN</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("Tapmad")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>Tapmad</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("Fifa World Cup 1")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>Fifa World Cup 1</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("Fifa World Cup 2")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>Fifa World Cup 2</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("SS World Cup Central")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>SS World Cup Central</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("T SPORTS")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>T-SPORTS</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("BD_Somoy TV")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>Somoy TV</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("CRIC || PTV SPORTS ᴴᴰ")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>PTV SPORTS HD</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("SS World Cup Pass")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>SS World Cup Pass</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("BEIN SPORTS MAX 1 HD")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>BEIN SPORTS MAX 1 HD</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("Fifa world Cup Spanish")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>Fifa world Cup Spanish</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("Directtv")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>Directtv</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("SUPER SPORTS FIFA")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>SUPER SPORTS FIFA</button>
            ...
            <button className="wc-watch-btn" onClick={() => onWatchLive("(DE) Fussball.TV1 (UHD/4K)")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>(DE) Fussball.TV1 (UHD/4K)</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("(HK) Now Sports 616 (UHD/4K)")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>(HK) Now Sports 616 (UHD/4K)</button>
          </div>
          {/* Schedule Section */}
