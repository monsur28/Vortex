      ...
      <div className="wc-grid" style={{ marginTop: '20px' }}>
        ...
        <div className="wc-matches-section">
          ...
          <div className="wc-channels-header" style={{ display: 'flex', gap: '8px', marginBottom: '16px', flexWrap: 'wrap', alignItems: 'center', background: 'rgba(15, 23, 42, 0.3)', padding: '10px 14px', borderRadius: '8px', border: '1px solid rgba(255, 255, 255, 0.05)' }}>
            ...
            <button className="wc-watch-btn" onClick={() => onWatchLive("BeIN Sports 1")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>BeIN Sports 1</button>
            ...
            <button className="wc-watch-btn" onClick={() => onWatchLive("Z Bangla")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>Z Bangla</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("Unite 8 Sports 1 HD")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>Unite 8</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("WIN Sports")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>WIN Sports</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("Tudn Sports")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>Tudn Sports</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("BIOSCOPE+")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>BIOSCOPE+</button>
            <button className="wc-watch-btn" onClick={() => onWatchLive("FIfa WOrld Cup TV")} style={{ padding: '5px 12px', height: 'auto', borderRadius: '4px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '800', border: 'none', cursor: 'pointer', fontSize: '10px', textTransform: 'uppercase' }}>FIfa WOrld Cup TV</button>
          </div>
          {/* Schedule Section */}
        ...
        {!isPlayerOpen && (
          <div className="wc-groups-panel" style={{ background: 'transparent', border: 'none', padding: 0 }}>
            ...
            <div style={{ background: 'linear-gradient(145deg, #1e293b, #0f172a)', borderRadius: '12px', border: '1px solid var(--wc-gold)', padding: '20px', marginBottom: '24px', position: 'relative', overflow: 'hidden', boxShadow: '0 10px 30px -10px rgba(0,0,0,0.5)' }}>
              ...
              {(matchOfTheDay.status === 'IN_PLAY' || matchOfTheDay.status === 'PAUSED') && (
                <button onClick={() => onWatchLive("BeIN Sports 1")} style={{ width: '100%', padding: '12px', borderRadius: '8px', background: 'linear-gradient(135deg, var(--wc-gold), #b45309)', color: 'black', fontWeight: '900', border: 'none', cursor: 'pointer', fontSize: '13px', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px', transition: 'all 0.2s', textTransform: 'uppercase' }}>
                  <PlayCircle size={18} /> Watch Stream
                </button>
              )}
            </div>
            )}
